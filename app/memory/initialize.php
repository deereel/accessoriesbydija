...
// Include this file in init.php to initialize the memory bank
...
$memory->save('issue_20260205_swiper_not_changing', [
    ...
    'lines_affected' => [28, 34, 39],
    'status' => 'fixed',
    'fixed_at' => date('Y-m-d H:i:s')
], ['issues', 'swiper', 'fixes']);

$memory->save('issue_20260205_account_api_db_path', [
    ...
    'files' => ['api/account/get_orders.php', 'api/account/get_addresses.php', 'api/account/get_order.php', 'api/account/save_address.php', 'api/account/delete_address.php', 'api/account/delete_account.php', 'api/account/change_password.php', 'api/account/update_profile.php'],
    'fix' => 'Changed require path from ../../config/database.php to ../../app/config/database.php',
    'status' => 'fixed',
    'fixed_at' => date('Y-m-d H:i:s')
], ['issues', 'database', 'fixes']);

$memory->save('issue_20260205_account_spacing', [
...
$memory->save('issue_20260205_checkout_country_dropdown', [
    ...
    'status' => 'fixed',
    'fixed_at' => date('Y-m-d H:i:s')
], ['issues', 'ui', 'improvement']);

$memory->save('issue_20260205_product_material_guidance', [
...
$memory->save('issue_20260205_mobile_search', [
    ...
    'status' => 'fixed',
    'fixed_at' => date('Y-m-d H:i:s')
], ['issues', 'mobile', 'search', 'ui']);

// Project context
$memory->save('project_context', [
    'name' => 'Accessories By Dija',
    'type' => 'E-commerce jewelry store',
    'tech_stack' => ['PHP', 'PDO', 'Swiper.js', 'MySQL'],
    'features' => ['Hero slider', 'Collection banners', 'Testimonials slider', 'Featured products', 'Custom jewelry requests', 'User account management'],
    'initialized_at' => '2026-02-05 00:00:00'
], ['project', 'context']);

// Database path verification
$memory->save('db_path_verification_20260205', [
    'files_verified' => [
        ['file' => 'app/includes/email.php', 'path' => "__DIR__ . '/../config/env.php'", 'resolves_to' => 'app/config/env.php', 'status' => 'correct'],
        ['file' => 'app/includes/logger.php', 'path' => "__DIR__ . '/../config/environment.php'", 'resolves_to' => 'app/config/environment.php', 'status' => 'correct']
    ],
    'verified_at' => date('Y-m-d H:i:s'),
    'note' => 'All __DIR__ relative paths are correct - they properly resolve to app/config/'
], ['database', 'paths', 'verification']);

// PWA fixes - Updated for images and filtering
$memory->save('issue_20260205_pwa_images_caching', [
    ...
    'files' => ['app/sw.js', 'api/filtered-products.php', 'api/featured-products.php', 'app/new-arrivals.php'],
    ...
    'status' => 'fixed',
    'fixed_at' => date('Y-m-d H:i:s')
], ['pwa', 'images', 'caching', 'fixes']);

$memory->save('issue_20260205_pwa_filtering', [
...
$memory->save('recent_changes', [
    ...
    [
        ...
        'files' => ['app/product.php', 'assets/js/product-details.js']
    ],
    [
        'date' => date('Y-m-d H:i:s'),
        'type' => 'improvement',
        ...
        'files' => ['app/includes/header.php', 'api/*.php']
    ],
    [
        'date' => date('Y-m-d H:i:s'),
        'type' => 'bugfix',
    ...
    [
        ...
        'files' => ['api/filtered-products.php', 'api/featured-products.php', 'app/new-arrivals.php']
    ],
    [
        'date' => date('Y-m-d H:i:s'),
        'type' => 'bugfix',
        ...
        'files' => ['assets/js/product-details.js']
    ],
    [
        'date' => date('Y-m-d H:i:s'),
        'type' => 'bugfix',
